...
namespace Test {
    ...
    partial class CSCompiledTokenizerWithLines {
    ...
    static int _ReadUtf32(System.Collections.Generic.IEnumerator<char> cursor, out int adv) {
        ...
        /// <summary>Indicates the VerbatimStringLiteral symbol id</summary>
        public const int VerbatimStringLiteral = 0;
        /// <summary>Indicates the StringLiteral symbol id</summary>
        public const int StringLiteral = 1;
        /// <summary>Indicates the CharacterLiteral symbol id</summary>
        public const int CharacterLiteral = 2;
        /// <summary>Indicates the IntegerLiteral symbol id</summary>
        public const int IntegerLiteral = 3;
        /// <summary>Indicates the FloatLiteral symbol id</summary>
        public const int FloatLiteral = 4;
        /// <summary>Indicates the Whitespace symbol id</summary>
        /// <remarks>This symbol is hidden and will not be reported by the tokenizer</remarks>
        public const int Whitespace = 5;
        /// <summary>Indicates the Identifier symbol id</summary>
        public const int Identifier = 6;
        /// <summary>Indicates the CommentBlock symbol id</summary>
        ...
        public static System.Collections.Generic.IEnumerable< (long AbsolutePosition, int AbsoluteLength, long Position, int Length, int SymbolId, string Value, int Line, int Column)> Tokenize(System.Collections.Generic.IEnumerable<char> text, long position = 0, int line = 1, int column = 1, int tabWidth = 4) {
            ...
            q3:
                    ...
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: StringLiteral, Value: sb.ToString(), Line: line, Column: column);
                    sb.Clear();
                    continue;
            q4:
                if(ch == '\t') {
            ...
            q8:
                    ...
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: CharacterLiteral, Value: sb.ToString(), Line: line, Column: column);
                    sb.Clear();
                    continue;
            q9:
                if(ch == '\t') {
            ...
            q12:
                ...
                if(ch == 'E' || ch == 'e') {
                    ...
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: FloatLiteral, Value: sb.ToString(), Line: line, Column: column);
                    sb.Clear();
                    continue;
            q13:
                    if(hasError)
            ...
            q18:
                    ...
                    if(_TokenizeCommentBlockBlockEnd(cursor,sb, ref cursorPos, ref absi, ref lc, ref cc, tabWidth, ref ch)) {
                        yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: CommentBlock, Value: sb.ToString(), Line: line, Column: column);
                        sb.Clear();
                        continue;
                    }
            ...
            q19:
                ...
                if(ch == 'x') {
                    ...
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: IntegerLiteral, Value: sb.ToString(), Line: line, Column: column);
                    sb.Clear();
                    continue;
            q20:
                if(ch == '.') {
            ...
            q43:
                if(ch == '\"') {
                    ...
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: VerbatimStringLiteral, Value: sb.ToString(), Line: line, Column: column);
                    sb.Clear();
                    continue;
            q44:
                if((ch >= '0' && ch <= '9') || (ch >= 'A' && ch <= 'Z') || (ch >= 'a' && ch <= 'z') || ch == 170 || ch == 181 || ch == 186 || (ch >= 192 && ch <= 214) || (ch >= 216 && ch <= 246) || (ch >= 248 && ch <= 705) || (ch >= 710 && ch <= 721) || (ch >= 736 && ch <= 740) || 
                    ...
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: Identifier, Value: sb.ToString(), Line: line, Column: column);
                    sb.Clear();
                    continue;
            error:
                if(!hasError)
        ...
        static bool _TokenizeCommentBlockBlockEnd(System.Collections.Generic.IEnumerator<char> cursor, System.Text.StringBuilder sb, ref long cursorPos, ref long absi, ref int lc, ref int cc, int tabWidth, ref int ch) {
            int adv;
            switch(ch) {
            case '\t':
                cc = (((cc - 1) / tabWidth) + 1) * tabWidth + 1;
        ...
        public static System.Collections.Generic.IEnumerable< (long AbsolutePosition, int AbsoluteLength, long Position, int Length, int SymbolId, string Value, int Line, int Column)> Tokenize(System.IO.TextReader text, long position = 0, int line = 1, int column = 1, int tabWidth = 4) {
            ...
            q18:
                    ...
                    if(_TokenizeCommentBlockBlockEnd(text,sb, ref cursorPos, ref absi, ref lc, ref cc, tabWidth, ref ch)) {
                        yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: CommentBlock, Value: sb.ToString(), Line: line, Column: column);
                        sb.Clear();
                        continue;
                    }
        ...
        static bool _TokenizeCommentBlockBlockEnd(System.IO.TextReader text, System.Text.StringBuilder sb, ref long cursorPos, ref long absi, ref int lc, ref int cc, int tabWidth, ref int ch) {
            int adv;
            switch(ch) {
            case '\t':
                cc = (((cc - 1) / tabWidth) + 1) * tabWidth + 1;
