...
namespace Test {
    ...
    partial class CSCompiledTokenizer {
    ...
    static int _ReadUtf32(System.Collections.Generic.IEnumerator<char> cursor, out int adv) {
        ...
        public static System.Collections.Generic.IEnumerable< (long AbsolutePosition, int AbsoluteLength, long Position, int Length, int SymbolId, string Value)> Tokenize(System.Collections.Generic.IEnumerable<char> text, long position = 0) {
            ...
            q3:
                   ...
                   yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: StringLiteral, Value: sb.ToString());
                    sb.Clear();
                    continue;
            q4:
                if((ch >= '\0' && ch <= '!') || (ch >= '#' && ch <= '[') || (ch >= ']' && ch <= 1114111)) {
            ...
            q8:
                   ...
                   yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: CharacterLiteral, Value: sb.ToString());
                    sb.Clear();
                    continue;
            q9:
            ...
            q12:
                ...
                if(ch == 'E' || ch == 'e') {
                   ...
                   yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: FloatLiteral, Value: sb.ToString());
                    sb.Clear();
                    continue;
            q13:
                    if(hasError)
            ...
            q18:
                    ...
                    if(_TokenizeCommentBlockBlockEnd(cursor,sb, ref cursorPos, ref absi, ref ch)) {
                        yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: CommentBlock, Value: sb.ToString());
                        sb.Clear();
                        continue;
                    }
            ...
            q19:
                ...
                if(ch == 'x') {
                   ...
                   yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: IntegerLiteral, Value: sb.ToString());
                    sb.Clear();
                    continue;
            q20:
                if(ch == '.') {
            ...
            q43:
                if(ch == '\"') {
                   ...
                   yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: VerbatimStringLiteral, Value: sb.ToString());
                    sb.Clear();
                    continue;
            q44:
                if((ch >= '0' && ch <= '9') || (ch >= 'A' && ch <= 'Z') || (ch >= 'a' && ch <= 'z') || ch == 170 || ch == 181 || ch == 186 || (ch >= 192 && ch <= 214) || (ch >= 216 && ch <= 246) || (ch >= 248 && ch <= 705) || (ch >= 710 && ch <= 721) || (ch >= 736 && ch <= 740) || 
                   ...
                   yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: Identifier, Value: sb.ToString());
                    sb.Clear();
                    continue;
            error:
                if(!hasError)
        ...
        static bool _TokenizeCommentBlockBlockEnd(System.Collections.Generic.IEnumerator<char> cursor, System.Text.StringBuilder sb, ref long cursorPos, ref long absi, ref int ch) {
            int adv;
            sb.Append(char.ConvertFromUtf32(ch));
            ch = _ReadUtf32(cursor, out adv);
            absi+=adv;
        ...
        public static System.Collections.Generic.IEnumerable< (long AbsolutePosition, int AbsoluteLength, long Position, int Length, int SymbolId, string Value)> Tokenize(System.IO.TextReader text, long position = 0) {
            ...
            q18:
                    ...
                    if(_TokenizeCommentBlockBlockEnd(text,sb, ref cursorPos, ref absi, ref ch)) {
                        yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: sb.Length, Position: position, Length: (int)(cursorPos-position), SymbolId: CommentBlock, Value: sb.ToString());
                        sb.Clear();
                        continue;
                    }
        ...
        static bool _TokenizeCommentBlockBlockEnd(System.IO.TextReader text, System.Text.StringBuilder sb, ref long cursorPos, ref long absi, ref int ch) {
            int adv;
            sb.Append(char.ConvertFromUtf32(ch));
            ch = _ReadUtf32(text, out adv);
            absi+=adv;
