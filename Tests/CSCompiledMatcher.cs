...
namespace Test {
    ...
    static int _ReadUtf32(System.Collections.Generic.IEnumerator<char> cursor, out int adv) {
        ...
        /// <param name="position">The logical cursor position where the counting starts.</param>
        /// <returns>An enumeration of tuple objects that contain the match information.</returns>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> MatchVerbatimStringLiteral(System.IO.TextReader text, long position = 0) {
            var sb = new System.Text.StringBuilder();
            int adv;
            var absoluteIndex = 0L;
            var absi = 0L;
        ...
        /// <param name="position">The logical cursor position where the counting starts.</param>
        /// <returns>An enumeration of tuple objects that contain the match information.</returns>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> MatchStringLiteral(System.IO.TextReader text, long position = 0) {
            var sb = new System.Text.StringBuilder();
            int adv;
            var absoluteIndex = 0L;
            var absi = 0L;
        ...
        /// <param name="position">The logical cursor position where the counting starts.</param>
        /// <returns>An enumeration of tuple objects that contain the match information.</returns>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> MatchCharacterLiteral(System.IO.TextReader text, long position = 0) {
            var sb = new System.Text.StringBuilder();
            int adv;
            var absoluteIndex = 0L;
            var absi = 0L;
        ...
        /// <param name="position">The logical cursor position where the counting starts.</param>
        /// <returns>An enumeration of tuple objects that contain the match information.</returns>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> MatchIntegerLiteral(System.IO.TextReader text, long position = 0) {
            var sb = new System.Text.StringBuilder();
            int adv;
            var absoluteIndex = 0L;
            var absi = 0L;
        ...
        /// <param name="position">The logical cursor position where the counting starts.</param>
        /// <returns>An enumeration of tuple objects that contain the match information.</returns>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> MatchFloatLiteral(System.IO.TextReader text, long position = 0) {
            var sb = new System.Text.StringBuilder();
            int adv;
            var absoluteIndex = 0L;
            var absi = 0L;
        ...
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> MatchCommentBlock(System.Collections.Generic.IEnumerable<char> text, long position = 0) {
            ...
            q1:
                ...
                goto next;
            q2:
                if(_MatchCommentBlockBlockEnd(cursor,sb, ref cursorPos, ref absi, ref ch)) {
        ...
        static bool _MatchCommentBlockBlockEnd(System.Collections.Generic.IEnumerator<char> cursor, System.Text.StringBuilder sb, ref long cursorPos, ref long absi, ref int ch) {
            int adv;
            while (ch != -1) {
            // q0:
                if(ch == '*') {
        ...
        /// <param name="position">The logical cursor position where the counting starts.</param>
        /// <returns>An enumeration of tuple objects that contain the match information.</returns>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> MatchCommentBlock(System.IO.TextReader text, long position = 0) {
            var sb = new System.Text.StringBuilder();
            int adv;
            var absoluteIndex = 0L;
            var absi = 0L;
            ...
            q1:
                ...
                goto next;
            q2:
                if(_MatchCommentBlockBlockEnd(text,sb, ref cursorPos, ref absi, ref ch)) {
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: (int)(absi - absoluteIndex), Position: position, Length: (int)(cursorPos - position), Value: sb.ToString());
                }
                continue;
            next:
        ...
        static bool _MatchCommentBlockBlockEnd(System.IO.TextReader text, System.Text.StringBuilder sb, ref long cursorPos, ref long absi, ref int ch) {
            int adv;
            while (ch != -1) {
            // q0:
                if(ch == '*') {
