...
USE [Test]
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_MatchVerbatimStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_MatchVerbatimStringLiteral] @value NVARCHAR(MAX), @position BIGINT = 0
AS
BEGIN
    ...
    q1:
        ...
        GOTO next
    q2:
        IF (@ch >= 0 AND @ch <= 33) OR (@ch >= 35 AND @ch <= 1114111)
		BEGIN
			SET @capture = @capture + @ch1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_IsVerbatimStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_IsVerbatimStringLiteral] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchVerbatimStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchVerbatimStringLiteral] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextIsVerbatimStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextIsVerbatimStringLiteral] @value NTEXT
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_MatchStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_MatchStringLiteral] @value NVARCHAR(MAX), @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
    ...
    -- q0:
        ...
        GOTO next
    q1:
        IF (@ch >= 0 AND @ch <= 33) OR (@ch >= 35 AND @ch <= 91) OR (@ch >= 93 AND @ch <= 1114111)
		BEGIN
			SET @capture = @capture + @ch1
			IF @tch < 2048 SET @capture = @capture + @ch2
			SET @index = @index + 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_IsStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_IsStringLiteral] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchStringLiteral] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextIsStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextIsStringLiteral] @value NTEXT
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_MatchCharacterLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_MatchCharacterLiteral] @value NVARCHAR(MAX), @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
    ...
    -- q0:
        ...
        GOTO next
    q1:
        IF (@ch >= 0 AND @ch <= 38) OR (@ch >= 40 AND @ch <= 91) OR (@ch >= 93 AND @ch <= 1114111)
		BEGIN
			SET @capture = @capture + @ch1
			IF @tch < 2048 SET @capture = @capture + @ch2
			SET @index = @index + 1
    ...
    q3:
        ...
        GOTO next
    q4:
        IF (@ch >= 0 AND @ch <= 38) OR (@ch >= 40 AND @ch <= 1114111)
		BEGIN
			SET @capture = @capture + @ch1
			IF @tch < 2048 SET @capture = @capture + @ch2
			SET @index = @index + 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_IsCharacterLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_IsCharacterLiteral] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchCharacterLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchCharacterLiteral] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextIsCharacterLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextIsCharacterLiteral] @value NTEXT
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_MatchIntegerLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_MatchIntegerLiteral] @value NVARCHAR(MAX), @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_IsIntegerLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_IsIntegerLiteral] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchIntegerLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchIntegerLiteral] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextIsIntegerLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextIsIntegerLiteral] @value NTEXT
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_MatchFloatLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_MatchFloatLiteral] @value NVARCHAR(MAX), @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_IsFloatLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_IsFloatLiteral] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchFloatLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchFloatLiteral] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextIsFloatLiteral]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextIsFloatLiteral] @value NTEXT
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_MatchWhitespace]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_MatchWhitespace] @value NVARCHAR(MAX), @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_IsWhitespace]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_IsWhitespace] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchWhitespace]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchWhitespace] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextIsWhitespace]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextIsWhitespace] @value NTEXT
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_MatchIdentifier]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_MatchIdentifier] @value NVARCHAR(MAX), @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_IsIdentifier]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_IsIdentifier] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchIdentifier]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchIdentifier] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextIsIdentifier]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextIsIdentifier] @value NTEXT
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_MatchCommentBlock]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_MatchCommentBlock] @value NVARCHAR(MAX), @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher__MatchCommentBlockBlockEnd]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher__MatchCommentBlockBlockEnd] @value NVARCHAR(MAX), @ch BIGINT, @tch BIGINT, @ch1 NCHAR, @ch2 NCHAR, @cursorPos BIGINT, @index INT, @valueEnd INT, @capture NVARCHAR(MAX), @newIndex INT OUTPUT, @newCursorPos BIGINT OUTPUT, @newCapture NVARCHAR(MAX) OUTPUT, @newCh BIGINT OUTPUT, @newTch BIGINT OUTPUT, @newCh1 NCHAR OUTPUT, @newCh2 NCHAR OUTPUT
AS
BEGIN
    WHILE @ch <> -1
    BEGIN
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_IsCommentBlock]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_IsCommentBlock] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
    ...
    q1:
        ...
        RETURN 0
    q2:
        EXEC @result = SqlCompiledMatcher__IsCommentBlockBlockEnd @value, @index, @ch
        RETURN @result
    END -- WHILE @ch <> -1
    RETURN 0
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher__IsCommentBlockBlockEnd]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher__IsCommentBlockBlockEnd] @value NVARCHAR(MAX), @index INT, @ch INT
AS
BEGIN
    DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @tch BIGINT
...
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchCommentBlock]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextMatchCommentBlock] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher__TextMatchCommentBlockBlockEnd]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher__TextMatchCommentBlockBlockEnd] @value NTEXT, @ch BIGINT, @tch BIGINT, @ch1 NCHAR, @ch2 NCHAR, @cursorPos BIGINT, @index INT, @valueEnd INT, @capture NVARCHAR(MAX), @newIndex INT OUTPUT, @newCursorPos BIGINT OUTPUT, @newCapture NVARCHAR(MAX) OUTPUT, @newCh BIGINT OUTPUT, @newTch BIGINT OUTPUT, @newCh1 NCHAR OUTPUT, @newCh2 NCHAR OUTPUT
AS
BEGIN
    WHILE @ch <> -1
    BEGIN
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher_TextIsCommentBlock]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher_TextIsCommentBlock] @value NTEXT
AS
BEGIN
    DECLARE @ch BIGINT
    DECLARE @tch BIGINT
...
END
GO
DROP PROCEDURE [dbo].[SqlCompiledMatcher__TextIsCommentBlockBlockEnd]
GO
CREATE PROCEDURE [dbo].[SqlCompiledMatcher__TextIsCommentBlockBlockEnd] @value NTEXT, @index INT, @ch INT
AS
BEGIN
    DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @tch BIGINT
