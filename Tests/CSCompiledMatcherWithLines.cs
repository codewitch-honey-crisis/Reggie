...
// Test.rgg specification file on 11/11/2021 7:34:19 AM UTC
namespace Test {
    ...
    partial class CSCompiledMatcherWithLines {
        ...
        static bool MatchCommentBlockBlockEnd(System.Collections.Generic.IEnumerator<char> cursor, System.Text.StringBuilder sb, ref long cursorPos, ref long absi, ref int ch, ref int lc, ref int cc, int tabWidth) {
            int adv;
            while(ch != -1) {
            // q0
                if(ch == '*') {
        ...
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value, int Line, int Column)> MatchCommentBlock(System.Collections.Generic.IEnumerable<char> text, long position = 0, int line = 1, int column = 1, int tabWidth = 4) {
            ...
            q1:
                ...
                goto next;
            q2:
                if(MatchCommentBlockBlockEnd(cursor, sb, ref cursorPos, ref absi, ref ch, ref lc, ref cc, tabWidth)) {
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: (int)(absi - absoluteIndex), Position: position, Length: (int)(cursorPos - position), Value: sb.ToString(), Line: line, Column: column);
                }
                continue;
            next:
