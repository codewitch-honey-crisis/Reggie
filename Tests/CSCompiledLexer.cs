...
// TestLexer.rgg specification file on 11/11/2021 7:34:19 AM UTC
namespace Test {
    ...
    partial class CSCompiledLexer {
        ...
        static bool TokenizeCommentBlockBlockEnd(System.Collections.Generic.IEnumerator<char> cursor, System.Text.StringBuilder sb, ref long cursorPos, ref long absi, ref int ch) {
            int adv = 0;
            bool matched;
            while(ch != -1) {
                matched = false;
        ...
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, int SymbolId, string Value)> Tokenize(System.Collections.Generic.IEnumerable<char> text, long position = 0) {
            int adv;
            ...
            q1:
                ...
                if(hasError) {
                    ...
                    yield return (AbsolutePosition: errorIndex, AbsoluteLength: ai, Position: errorPos, Length: (int)(position - errorPos), SymbolId: ERROR, Value: sb.ToString(0, ai));
                    sb.Remove(0, ai);
                    hasError = false;
            ...
            q3:
                ...
                if(sb.Length > 0) {
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: (int)(absi - absoluteIndex), Position: position, Length: (int)(cursorPos - position), SymbolId: StringLiteral, Value: sb.ToString());
                }
                sb.Clear();
                continue;
            q4:
            ...
            q8:
                ...
                if(sb.Length > 0) {
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: (int)(absi - absoluteIndex), Position: position, Length: (int)(cursorPos - position), SymbolId: CharacterLiteral, Value: sb.ToString());
                }
                sb.Clear();
                continue;
            q9:
            ...
            q12:
                ...
                if(sb.Length > 0) {
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: (int)(absi - absoluteIndex), Position: position, Length: (int)(cursorPos - position), SymbolId: FloatLiteral, Value: sb.ToString());
                }
                sb.Clear();
                continue;
            q13:
            ...
            q18:
                ...
                if(TokenizeCommentBlockBlockEnd(cursor, sb, ref cursorPos, ref absi, ref ch)) {
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: (int)(absi - absoluteIndex), Position: position, Length: (int)(cursorPos - position), SymbolId: CommentBlock, Value: sb.ToString());
                    sb.Clear();
                    continue;
                }
            ...
            q19:
                ...
                if(sb.Length > 0) {
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: (int)(absi - absoluteIndex), Position: position, Length: (int)(cursorPos - position), SymbolId: IntegerLiteral, Value: sb.ToString());
                }
                sb.Clear();
                continue;
            q20:
            ...
            q43:
                ...
                if(sb.Length > 0) {
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: (int)(absi - absoluteIndex), Position: position, Length: (int)(cursorPos - position), SymbolId: VerbatimStringLiteral, Value: sb.ToString());
                }
                sb.Clear();
                continue;
            q44:
                ...
                if(sb.Length > 0) {
                    yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: (int)(absi - absoluteIndex), Position: position, Length: (int)(cursorPos - position), SymbolId: Identifier, Value: sb.ToString());
                }
                sb.Clear();
                continue;
            error:
            ...
            if(hasError && sb.Length > 0) {
                yield return (AbsolutePosition: errorIndex, AbsoluteLength: sb.Length, Position: errorPos, Length: (int)(cursorPos - errorPos), SymbolId: ERROR, Value: sb.ToString());
