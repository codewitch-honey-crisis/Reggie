...
DROP PROCEDURE [dbo].[SqlCompiledChecker_IsVerbatimStringLiteral]
GO
...
CREATE PROCEDURE [dbo].[SqlCompiledChecker_IsVerbatimStringLiteral] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @adv INT
    DECLARE @ch BIGINT
...
GO
DROP PROCEDURE [dbo].[SqlCompiledChecker_IsStringLiteral]
GO
-- <summary>Indicates whether the <paramref name="text"/> matches the expression indicated by StringLiteral</summary>
-- <param name="text">The text to validate</param>
-- <returns>True if the entire contents match the expression, otherwise false</returns>
CREATE PROCEDURE [dbo].[SqlCompiledChecker_IsStringLiteral] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @adv INT
    DECLARE @ch BIGINT
...
END -- CREATE PROCEDURE
GO
DROP PROCEDURE [dbo].[SqlCompiledChecker_IsCharacterLiteral]
GO
-- <summary>Indicates whether the <paramref name="text"/> matches the expression indicated by CharacterLiteral</summary>
-- <param name="text">The text to validate</param>
-- <returns>True if the entire contents match the expression, otherwise false</returns>
CREATE PROCEDURE [dbo].[SqlCompiledChecker_IsCharacterLiteral] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @adv INT
    DECLARE @ch BIGINT
...
END -- CREATE PROCEDURE
GO
DROP PROCEDURE [dbo].[SqlCompiledChecker_IsIntegerLiteral]
GO
-- <summary>Indicates whether the <paramref name="text"/> matches the expression indicated by IntegerLiteral</summary>
-- <param name="text">The text to validate</param>
-- <returns>True if the entire contents match the expression, otherwise false</returns>
CREATE PROCEDURE [dbo].[SqlCompiledChecker_IsIntegerLiteral] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @adv INT
    DECLARE @ch BIGINT
...
END -- CREATE PROCEDURE
GO
DROP PROCEDURE [dbo].[SqlCompiledChecker_IsFloatLiteral]
GO
-- <summary>Indicates whether the <paramref name="text"/> matches the expression indicated by FloatLiteral</summary>
-- <param name="text">The text to validate</param>
-- <returns>True if the entire contents match the expression, otherwise false</returns>
CREATE PROCEDURE [dbo].[SqlCompiledChecker_IsFloatLiteral] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @adv INT
    DECLARE @ch BIGINT
...
END -- CREATE PROCEDURE
GO
DROP PROCEDURE [dbo].[SqlCompiledChecker_IsWhitespace]
GO
-- <summary>Indicates whether the <paramref name="text"/> matches the expression indicated by Whitespace</summary>
-- <param name="text">The text to validate</param>
-- <returns>True if the entire contents match the expression, otherwise false</returns>
CREATE PROCEDURE [dbo].[SqlCompiledChecker_IsWhitespace] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @adv INT
    DECLARE @ch BIGINT
...
END -- CREATE PROCEDURE
GO
DROP PROCEDURE [dbo].[SqlCompiledChecker_IsIdentifier]
GO
-- <summary>Indicates whether the <paramref name="text"/> matches the expression indicated by Identifier</summary>
-- <param name="text">The text to validate</param>
-- <returns>True if the entire contents match the expression, otherwise false</returns>
CREATE PROCEDURE [dbo].[SqlCompiledChecker_IsIdentifier] @value NVARCHAR(MAX)
AS
BEGIN
    DECLARE @adv INT
    DECLARE @ch BIGINT
