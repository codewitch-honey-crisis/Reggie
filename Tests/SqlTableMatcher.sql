...
DROP PROCEDURE [dbo].[SqlTableMatcher_Is]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_Is] @value NVARCHAR(MAX), @symbolId INT
AS
BEGIN
	...
	END
	SET @accept = -1
	SELECT @accept = [dbo].[SqlTableMatcherState].[SymbolId] FROM [dbo].[SqlTableMatcherState] WHERE [dbo].[SqlTableMatcherState].[SymbolId] = @symbolId AND [dbo].[SqlTableMatcherState].[StateId] = @state AND [dbo].[SqlTableMatcherState].[BlockEndId] = -1 AND [dbo].[SqlTableMatcherState].[Accepts]=1
	IF @accept <> -1 
	BEGIN
		SELECT TOP 1 @blockEndId = [dbo].[SqlTableMatcherState].[BlockEndId] FROM [dbo].[SqlTableMatcherState] WHERE [dbo].[SqlTableMatcherState].[SymbolId]=@symbolId AND [dbo].[SqlTableMatcherState].[BlockEndId] <> -1
		IF @blockEndId <> -1 
		BEGIN
			SET @result = 0
			SET @state = 0
			...
			BEGIN
				SET @toState = -1
				SELECT @toState = [dbo].[SqlTableMatcherStateTransition].[ToStateId] FROM [dbo].[SqlTableMatcherState] INNER JOIN [dbo].[SqlTableMatcherStateTransition] ON [dbo].[SqlTableMatcherState].[StateId]=[dbo].[SqlTableMatcherStateTransition].[StateId] AND [dbo].[SqlTableMatcherState].[SymbolId]=[dbo].[SqlTableMatcherStateTransition].[SymbolId] AND [dbo].[SqlTableMatcherStateTransition].[BlockEndId]=@blockEndId WHERE [dbo].[SqlTableMatcherState].[SymbolId]=@symbolId AND [dbo].[SqlTableMatcherState].[StateId]=@state AND [dbo].[SqlTableMatcherState].[BlockEndId] = @blockEndId AND @ch BETWEEN [dbo].[SqlTableMatcherStateTransition].[Min] AND [dbo].[SqlTableMatcherStateTransition].[Max] 
				IF @toState <> -1
				BEGIN
					SET @state = @toState
					SET @index = @index + 1
				...
				BEGIN
					SET @accept = -1
					SELECT @accept = [dbo].[SqlTableMatcherState].[SymbolId] FROM [dbo].[SqlTableMatcherState] WHERE [dbo].[SqlTableMatcherState].[SymbolId] = @symbolId AND [dbo].[SqlTableMatcherState].[StateId] = @state AND [dbo].[SqlTableMatcherState].[BlockEndId] = @blockEndId AND [dbo].[SqlTableMatcherState].[Accepts]=1
					IF @accept = -1 
					BEGIN
...
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_Match]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_Match] @value NVARCHAR(MAX), @symbolId INT, @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextIs]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextIs] @value NTEXT, @symbolId INT
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextMatch]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextMatch] @value NTEXT, @symbolId INT, @position BIGINT = 0
AS
BEGIN
	DECLARE @valueEnd INT = DATALENGTH(@value)/2+1
	DECLARE @index INT = 1
...
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_IsVerbatimStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_IsVerbatimStringLiteral] @value NVARCHAR(1024) 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_Is] @value = @value, @symbolId = 0
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextIsVerbatimStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextIsVerbatimStringLiteral] @value NTEXT 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_TextIs] @value = @value, @symbolId = 0
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_MatchVerbatimStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_MatchVerbatimStringLiteral] @value NVARCHAR(1024), @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_Match] @value = @value, @symbolId = 0, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextMatchVerbatimStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextMatchVerbatimStringLiteral] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_TextMatch] @value = @value, @symbolId = 0, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_IsStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_IsStringLiteral] @value NVARCHAR(1024) 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_Is] @value = @value, @symbolId = 1
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextIsStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextIsStringLiteral] @value NTEXT 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_TextIs] @value = @value, @symbolId = 1
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_MatchStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_MatchStringLiteral] @value NVARCHAR(1024), @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_Match] @value = @value, @symbolId = 1, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextMatchStringLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextMatchStringLiteral] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_TextMatch] @value = @value, @symbolId = 1, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_IsCharacterLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_IsCharacterLiteral] @value NVARCHAR(1024) 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_Is] @value = @value, @symbolId = 2
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextIsCharacterLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextIsCharacterLiteral] @value NTEXT 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_TextIs] @value = @value, @symbolId = 2
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_MatchCharacterLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_MatchCharacterLiteral] @value NVARCHAR(1024), @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_Match] @value = @value, @symbolId = 2, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextMatchCharacterLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextMatchCharacterLiteral] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_TextMatch] @value = @value, @symbolId = 2, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_IsIntegerLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_IsIntegerLiteral] @value NVARCHAR(1024) 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_Is] @value = @value, @symbolId = 3
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextIsIntegerLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextIsIntegerLiteral] @value NTEXT 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_TextIs] @value = @value, @symbolId = 3
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_MatchIntegerLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_MatchIntegerLiteral] @value NVARCHAR(1024), @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_Match] @value = @value, @symbolId = 3, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextMatchIntegerLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextMatchIntegerLiteral] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_TextMatch] @value = @value, @symbolId = 3, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_IsFloatLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_IsFloatLiteral] @value NVARCHAR(1024) 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_Is] @value = @value, @symbolId = 4
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextIsFloatLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextIsFloatLiteral] @value NTEXT 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_TextIs] @value = @value, @symbolId = 4
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_MatchFloatLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_MatchFloatLiteral] @value NVARCHAR(1024), @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_Match] @value = @value, @symbolId = 4, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextMatchFloatLiteral]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextMatchFloatLiteral] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_TextMatch] @value = @value, @symbolId = 4, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_IsWhitespace]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_IsWhitespace] @value NVARCHAR(1024) 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_Is] @value = @value, @symbolId = 5
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextIsWhitespace]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextIsWhitespace] @value NTEXT 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_TextIs] @value = @value, @symbolId = 5
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_MatchWhitespace]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_MatchWhitespace] @value NVARCHAR(1024), @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_Match] @value = @value, @symbolId = 5, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextMatchWhitespace]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextMatchWhitespace] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_TextMatch] @value = @value, @symbolId = 5, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_IsIdentifier]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_IsIdentifier] @value NVARCHAR(1024) 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_Is] @value = @value, @symbolId = 6
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextIsIdentifier]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextIsIdentifier] @value NTEXT 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_TextIs] @value = @value, @symbolId = 6
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_MatchIdentifier]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_MatchIdentifier] @value NVARCHAR(1024), @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_Match] @value = @value, @symbolId = 6, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextMatchIdentifier]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextMatchIdentifier] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_TextMatch] @value = @value, @symbolId = 6, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_IsCommentBlock]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_IsCommentBlock] @value NVARCHAR(1024) 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_Is] @value = @value, @symbolId = 40
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextIsCommentBlock]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextIsCommentBlock] @value NTEXT 
AS
BEGIN
	DECLARE @result INT = 0
	EXEC @result = [dbo].[SqlTableMatcher_TextIs] @value = @value, @symbolId = 40
	RETURN @result
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_MatchCommentBlock]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_MatchCommentBlock] @value NVARCHAR(1024), @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_Match] @value = @value, @symbolId = 40, @position = @position
END
GO
DROP PROCEDURE [dbo].[SqlTableMatcher_TextMatchCommentBlock]
GO
CREATE PROCEDURE [dbo].[SqlTableMatcher_TextMatchCommentBlock] @value NTEXT, @position BIGINT = 0
AS
BEGIN
	EXEC [dbo].[SqlTableMatcher_TextMatch] @value = @value, @symbolId = 40, @position = @position
END
GO
...
INSERT INTO [dbo].[SqlTableMatcherSymbol] VALUES(5, 1,N'Whitespace')
...
INSERT INTO [dbo].[SqlTableMatcherState] VALUES(40, 0, 0, -1)
INSERT INTO [dbo].[SqlTableMatcherStateTransition] VALUES(40, 0,-1,1,47,47)
INSERT INTO [dbo].[SqlTableMatcherState] VALUES(40, 1, 0, -1)
INSERT INTO [dbo].[SqlTableMatcherStateTransition] VALUES(40, 1,-1,2,42,42)
INSERT INTO [dbo].[SqlTableMatcherState] VALUES(40, 2, 1, -1)
INSERT INTO [dbo].[SqlTableMatcherSymbol] VALUES(40, 0,N'CommentBlock')
INSERT INTO [dbo].[SqlTableMatcherState] VALUES(40, 0, 0,0)
INSERT INTO [dbo].[SqlTableMatcherStateTransition] VALUES(40,0,0,1,42,42)
INSERT INTO [dbo].[SqlTableMatcherState] VALUES(40, 1, 0,0)
INSERT INTO [dbo].[SqlTableMatcherStateTransition] VALUES(40,1,0,2,47,47)
INSERT INTO [dbo].[SqlTableMatcherState] VALUES(40, 2, 1,0)
COMMIT
GO
