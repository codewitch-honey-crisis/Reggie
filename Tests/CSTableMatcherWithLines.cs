...
// Test.rgg specification file on 11/8/2021 6:24:02 AM UTC
namespace Test {
    ...
    partial class CSTableMatcherWithLines {
        ...
        static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value, int Line, int Column)> TableMatch(int[] dfa, int[] blockEnd, System.Collections.Generic.IEnumerable<char> text, long position, int line, int column, int tabWidth) {
            int adv;
                ...
                if(acc != -1) {
                    if(blockEnd != null) {
                        ...
                        while(ch != -1) {
                            ...
                            if(acc != -1) {
                                yield return (AbsolutePosition: absoluteIndex, AbsoluteLength: (int)(absi - absoluteIndex), Position: position, Length: (int)(cursorPos - position), Value: sb.ToString(), Line: line, Column: column);
                                break;
                            }
                            else {
                                switch (ch) {
        ...
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value, int Line, int Column)> MatchVerbatimStringLiteral(System.Collections.Generic.IEnumerable<char> text, long position = 0, int line = 1, int column = 1, int tabWidth = 4) {
            foreach(var result in TableMatch(VerbatimStringLiteralDfaStateTable, null, text, position, line, column, tabWidth)) {
            	yield return result;
            }
        }
        ...
        /// <returns>An enumeration of tuples used to retrieve the match values.</returns>
        /// <remarks>The matches contain both the absolute native character position within <paramref name="text"/> and the logical position in UTF32 codepoints for each match. The former is useful for locating the match within a string programmatically while the latter is useful for locating text within a document based on its logical position.</remarks>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value, int Line, int Column)> MatchStringLiteral(System.Collections.Generic.IEnumerable<char> text, long position = 0, int line = 1, int column = 1, int tabWidth = 4) {
            foreach(var result in TableMatch(StringLiteralDfaStateTable, null, text, position, line, column, tabWidth)) {
            	yield return result;
            }
        }
        ...
        /// <returns>An enumeration of tuples used to retrieve the match values.</returns>
        /// <remarks>The matches contain both the absolute native character position within <paramref name="text"/> and the logical position in UTF32 codepoints for each match. The former is useful for locating the match within a string programmatically while the latter is useful for locating text within a document based on its logical position.</remarks>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value, int Line, int Column)> MatchCharacterLiteral(System.Collections.Generic.IEnumerable<char> text, long position = 0, int line = 1, int column = 1, int tabWidth = 4) {
            foreach(var result in TableMatch(CharacterLiteralDfaStateTable, null, text, position, line, column, tabWidth)) {
            	yield return result;
            }
        }
        ...
        /// <returns>An enumeration of tuples used to retrieve the match values.</returns>
        /// <remarks>The matches contain both the absolute native character position within <paramref name="text"/> and the logical position in UTF32 codepoints for each match. The former is useful for locating the match within a string programmatically while the latter is useful for locating text within a document based on its logical position.</remarks>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value, int Line, int Column)> MatchIntegerLiteral(System.Collections.Generic.IEnumerable<char> text, long position = 0, int line = 1, int column = 1, int tabWidth = 4) {
            foreach(var result in TableMatch(IntegerLiteralDfaStateTable, null, text, position, line, column, tabWidth)) {
            	yield return result;
            }
        }
        ...
        /// <returns>An enumeration of tuples used to retrieve the match values.</returns>
        /// <remarks>The matches contain both the absolute native character position within <paramref name="text"/> and the logical position in UTF32 codepoints for each match. The former is useful for locating the match within a string programmatically while the latter is useful for locating text within a document based on its logical position.</remarks>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value, int Line, int Column)> MatchFloatLiteral(System.Collections.Generic.IEnumerable<char> text, long position = 0, int line = 1, int column = 1, int tabWidth = 4) {
            foreach(var result in TableMatch(FloatLiteralDfaStateTable, null, text, position, line, column, tabWidth)) {
            	yield return result;
            }
        }
        ...
        /// <returns>An enumeration of tuples used to retrieve the match values.</returns>
        /// <remarks>The matches contain both the absolute native character position within <paramref name="text"/> and the logical position in UTF32 codepoints for each match. The former is useful for locating the match within a string programmatically while the latter is useful for locating text within a document based on its logical position.</remarks>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value, int Line, int Column)> MatchWhitespace(System.Collections.Generic.IEnumerable<char> text, long position = 0, int line = 1, int column = 1, int tabWidth = 4) {
            foreach(var result in TableMatch(WhitespaceDfaStateTable, null, text, position, line, column, tabWidth)) {
            	yield return result;
            }
        }
        ...
        /// <returns>An enumeration of tuples used to retrieve the match values.</returns>
        /// <remarks>The matches contain both the absolute native character position within <paramref name="text"/> and the logical position in UTF32 codepoints for each match. The former is useful for locating the match within a string programmatically while the latter is useful for locating text within a document based on its logical position.</remarks>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value, int Line, int Column)> MatchIdentifier(System.Collections.Generic.IEnumerable<char> text, long position = 0, int line = 1, int column = 1, int tabWidth = 4) {
            foreach(var result in TableMatch(IdentifierDfaStateTable, null, text, position, line, column, tabWidth)) {
            	yield return result;
            }
        }
        ...
        /// <returns>An enumeration of tuples used to retrieve the match values.</returns>
        /// <remarks>The matches contain both the absolute native character position within <paramref name="text"/> and the logical position in UTF32 codepoints for each match. The former is useful for locating the match within a string programmatically while the latter is useful for locating text within a document based on its logical position.</remarks>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value, int Line, int Column)> MatchCommentBlock(System.Collections.Generic.IEnumerable<char> text, long position = 0, int line = 1, int column = 1, int tabWidth = 4) {
            foreach(var result in TableMatch(CommentBlockDfaStateTable, CommentBlockBlockEndDfaStateTable, text, position, line, column, tabWidth)) {
            	yield return result;
            }
        }
