...
-- TestLexer.rgg specification file on 11/11/2021 7:34:22 AM UTC
use [Test]
GO
...
DROP PROCEDURE [dbo].[SqlCompiledLexerWithLines_TokenizeCommentBlockBlockEnd]
GO
CREATE PROCEDURE [dbo].[SqlCompiledLexerWithLines_TokenizeCommentBlockBlockEnd] @value NVARCHAR(MAX), @ch BIGINT, @tch BIGINT, @ch1 NCHAR, @ch2 NCHAR, @cursorPos BIGINT, @absi BIGINT, @index INT, @valueEnd INT, @capture NVARCHAR(MAX), @lc INT, @cc INT, @tabWidth INT, @newIndex INT OUTPUT, @newCursorPos BIGINT OUTPUT, @newAbsi INT OUTPUT, @newCapture NVARCHAR(MAX) OUTPUT, @newCh BIGINT OUTPUT, @newTch BIGINT OUTPUT, @newCh1 NCHAR OUTPUT, @newCh2 NCHAR OUTPUT, @newLC INT OUTPUT, @newCC INT OUTPUT
AS
BEGIN
    DECLARE @adv INT = 0
    DECLARE @matched INT
...
GO
DROP PROCEDURE [dbo].[SqlCompiledLexerWithLines_Tokenize]
GO
...
CREATE PROCEDURE [dbo].[SqlCompiledLexerWithLines_Tokenize] @value NVARCHAR(MAX), @position BIGINT = 0, @line INT = 1, @column INT = 1, @tabWidth INT = 4
AS
BEGIN
    DECLARE @adv INT
    ...
    q1:
        ...
        BEGIN
            ...
            INSERT INTO #Results SELECT @errorIndex AS [AbsolutePosition], @ai AS [AbsoluteLength], @errorPos AS [Position], CAST((@position - @errorPos) AS INT) AS [Length], -1 AS [SymbolId], @tmp AS [Value], @errorLine AS [Line], @errorColumn AS [Column]
    ...
    q3:
        ...
        BEGIN
            INSERT INTO #Results SELECT @absoluteIndex AS [AbsolutePosition], CAST((@absi - @absoluteIndex) AS INT) AS [AbsoluteLength], @position AS [Position], CAST((@cursorPos - @position) AS INT) AS [Length], 1 AS [SymbolId], @capture AS [Value], @line AS [Line], @column AS [Column]
        END
        SET @capture = N''
        CONTINUE
    q4:
    ...
    q8:
        ...
        IF DATALENGTH(@capture) > 0
        BEGIN
            INSERT INTO #Results SELECT @absoluteIndex AS [AbsolutePosition], CAST((@absi - @absoluteIndex) AS INT) AS [AbsoluteLength], @position AS [Position], CAST((@cursorPos - @position) AS INT) AS [Length], 2 AS [SymbolId], @capture AS [Value], @line AS [Line], @column AS [Column]
        END
        SET @capture = N''
        CONTINUE
    q9:
    ...
    q12:
        ...
        IF DATALENGTH(@capture) > 0
        BEGIN
            INSERT INTO #Results SELECT @absoluteIndex AS [AbsolutePosition], CAST((@absi - @absoluteIndex) AS INT) AS [AbsoluteLength], @position AS [Position], CAST((@cursorPos - @position) AS INT) AS [Length], 4 AS [SymbolId], @capture AS [Value], @line AS [Line], @column AS [Column]
        END
        SET @capture = N''
        CONTINUE
    q13:
    ...
    q18:
        ...
        END
        EXEC @len = [dbo].[SqlCompiledLexerWithLines_TokenizeCommentBlockBlockEnd] @value = @value, @ch = @ch,  @tch = @tch, @ch1 = @ch1, @ch2 = @ch2, @cursorPos = @cursorPos, @absi = @absi, @index = @index, @valueEnd = @valueEnd, @capture = @capture, @lc = @lc, @cc = @cc, @tabwidth = @tabWidth, @newIndex = @newIndex OUTPUT, @newCursorPos = @newCursorPos OUTPUT, @newAbsi = @newAbsi OUTPUT, @newCapture = @newCapture OUTPUT, @newCh = @newCh OUTPUT, @newTch = @newTch OUTPUT, @newCh1 = @newCh1 OUTPUT, @newCh2 = @newCh2 OUTPUT, @newLC = @newLC OUTPUT, @newCC = @newCC OUTPUT
        SET @index = @newIndex
        SET @absi = @newAbsi
        ...
        IF @len <> 0
        BEGIN
            INSERT INTO #Results SELECT @absoluteIndex AS [AbsolutePosition], CAST((@absi - @absoluteIndex) AS INT) AS [AbsoluteLength], @position AS [Position], CAST((@cursorPos - @position) AS INT) AS [Length], 40 AS [SymbolId], @capture AS [Value], @line AS [Line], @column AS [Column]
            SET @capture = N''
            CONTINUE
        END -- IF not matched
        INSERT INTO #Results SELECT @absoluteIndex AS [AbsolutePosition], DATALENGTH(@capture) / 2 AS [AbsoluteLength], @position AS [Position], CAST((@cursorPos - @position) AS INT) AS [Length], -1 AS [SymbolId], @capture AS [Value], @line AS [Line], @column AS [Column]
    ...
    q19:
        ...
        IF DATALENGTH(@capture) > 0
        BEGIN
            INSERT INTO #Results SELECT @absoluteIndex AS [AbsolutePosition], CAST((@absi - @absoluteIndex) AS INT) AS [AbsoluteLength], @position AS [Position], CAST((@cursorPos - @position) AS INT) AS [Length], 3 AS [SymbolId], @capture AS [Value], @line AS [Line], @column AS [Column]
        END
        SET @capture = N''
        CONTINUE
    q20:
    ...
    q43:
        ...
        IF DATALENGTH(@capture) > 0
        BEGIN
            INSERT INTO #Results SELECT @absoluteIndex AS [AbsolutePosition], CAST((@absi - @absoluteIndex) AS INT) AS [AbsoluteLength], @position AS [Position], CAST((@cursorPos - @position) AS INT) AS [Length], 0 AS [SymbolId], @capture AS [Value], @line AS [Line], @column AS [Column]
        END
        SET @capture = N''
        CONTINUE
    q44:
        ...
        IF DATALENGTH(@capture) > 0
        BEGIN
            INSERT INTO #Results SELECT @absoluteIndex AS [AbsolutePosition], CAST((@absi - @absoluteIndex) AS INT) AS [AbsoluteLength], @position AS [Position], CAST((@cursorPos - @position) AS INT) AS [Length], 6 AS [SymbolId], @capture AS [Value], @line AS [Line], @column AS [Column]
        END
        SET @capture = N''
        CONTINUE
    error:
    ...
    BEGIN
        INSERT INTO #Results SELECT @errorIndex AS [AbsolutePosition], DATALENGTH(@capture) / 2 AS [AbsoluteLength], @errorPos AS [Position], CAST((@cursorPos - @errorPos) AS INT) AS [Length], -1 AS [SymbolId], @capture AS [Value], @errorLine AS [Line], @errorColumn AS [Column]
