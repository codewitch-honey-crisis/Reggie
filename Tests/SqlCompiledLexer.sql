...
-- TestLexer.rgg specification file on 11/11/2021 7:34:21 AM UTC
use [Test]
GO
...
GO
DROP PROCEDURE [dbo].[SqlCompiledLexer_Tokenize]
GO
...
CREATE PROCEDURE [dbo].[SqlCompiledLexer_Tokenize] @value NVARCHAR(MAX), @position BIGINT = 0
AS
BEGIN
    DECLARE @adv INT
