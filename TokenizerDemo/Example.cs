...
/// <summary>Represents a single token in a tokenized input stream</summary>
    ...
    public static System.Collections.Generic.IEnumerable<Token> Tokenize(System.Collections.Generic.IEnumerable<char> text, long position = 0) {
        ...
        q2:
            ...
            goto error;
        q3:
            yield return new Token(StringLiteral, sb.ToString(), position);
                continue;
        q4:
            if((ch >= '\0' && ch <= '!') || (ch >= '#' && ch <= '[') || (ch >= ']' && ch <= 1114111)) {
                sb.Append(char.ConvertFromUtf32(ch));
        ...
        q7:
            ...
            goto error;
        q8:
            yield return new Token(CharacterLiteral, sb.ToString(), position);
                continue;
        q9:
        ...
        q12:
            ...
            yield return new Token(FloatLiteral, sb.ToString(), position);
                continue;
        q13:
            yield return new Token(FloatLiteral, sb.ToString(), position);
                continue;
        ...
        q17:
            ...
            goto error;
        q18:
                if(_TokenizeCommentBlockBlockEnd(cursor,sb, ref cursorPos, ref ch)) {    
                    yield return new Token(CommentBlock, sb.ToString(), position);
                continue;
                }
        ...
        q19:
            ...
            yield return new Token(IntegerLiteral, sb.ToString(), position);
                continue;
        q20:
            if(ch == '.') {
                sb.Append(unchecked((char)ch));
        ...
        q43:
            ...
            yield return new Token(VerbatimStringLiteral, sb.ToString(), position);
                continue;
        q44:
            ...
            yield return new Token(Identifier, sb.ToString(), position);
                continue;
        error:
            ...
            ch >= '1' && ch <= '9' || 
            ch == '@' || 
            (ch >= 'A' && ch <= 'Z') || (ch >= 'a' && ch <= 'z') || ch == 170 || ch == 181 || ch == 186 || (ch >= 192 && ch <= 214) || (ch >= 216 && ch <= 246) || (ch >= 248 && ch <= 705) || (ch >= 710 && ch <= 721) || (ch >= 736 && ch <= 740) || ch == 748 || 
                    ch == 750 || (ch >= 880 && ch <= 884) || ch == 886 || ch == 887 || (ch >= 890 && ch <= 893) || ch == 895 || ch == 902 || (ch >= 904 && ch <= 906) || ch == 908 || (ch >= 910 && ch <= 929) || (ch >= 931 && ch <= 1013) || 
                    (ch >= 1015 && ch <= 1153) || (ch >= 1162 && ch <= 1327) || (ch >= 1329 && ch <= 1366) || ch == 1369 || (ch >= 1377 && ch <= 1415) || (ch >= 1488 && ch <= 1514) || (ch >= 1520 && ch <= 1522) || (ch >= 1568 && ch <= 1610) || ch == 1646 || ch == 1647 || (ch >= 1649 && ch <= 1747) || 
                    ch == 1749 || ch == 1765 || ch == 1766 || ch == 1774 || ch == 1775 || (ch >= 1786 && ch <= 1788) || ch == 1791 || ch == 1808 || (ch >= 1810 && ch <= 1839) || (ch >= 1869 && ch <= 1957) || ch == 1969 || (ch >= 1994 && ch <= 2026) || 
                    ch == 2036 || ch == 2037 || ch == 2042 || (ch >= 2048 && ch <= 2069) || ch == 2074 || ch == 2084 || ch == 2088 || (ch >= 2112 && ch <= 2136) || (ch >= 2208 && ch <= 2228) || (ch >= 2308 && ch <= 2361) || ch == 2365 || 
    ...
    static bool _TokenizeCommentBlockBlockEnd(System.Collections.Generic.IEnumerator<char> cursor, System.Text.StringBuilder sb, ref long cursorPos, ref int ch) {
        ch = _FetchNextInput(cursor);
        while (ch != -1) {
            sb.Clear();
        // q0:
    ...
    public static System.Collections.Generic.IEnumerable<Token> Tokenize(System.IO.TextReader text, long position = 0) {
        ...
        q17:
            ...
            goto error;
        q18:
                if(_TokenizeCommentBlockBlockEnd(text,sb, ref cursorPos, ref ch)) {    
                    yield return new Token(CommentBlock, sb.ToString(), position);
                continue;
                }
                yield return new Token(ERROR, sb.ToString(), position);
    ...
    static bool _TokenizeCommentBlockBlockEnd(System.IO.TextReader text, System.Text.StringBuilder sb, ref long cursorPos, ref int ch) {
        ch = _FetchNextInput(text);
        while (ch != -1) {
            sb.Clear();
        // q0:
