...
// Example.rgg specification file on 11/8/2021 6:45:35 AM UTC
namespace ReggiePerf {
    
    /// <summary>Represents a matcher for the regular expressions in Example.rgg</summary>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Reggie", "0.9.6.0")]
    partial class ExampleCompiledMatcher {
        ...
        /// <summary>Returns all occurances of the expression indicated by String within <paramref name="text"/></summary>
        ...
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> MatchString(System.IO.TextReader text, long position = 0) {
            int adv;
        ...
        /// <returns>An enumeration of tuples used to retrieve the match values.</returns>
        /// <remarks>The matches contain both the absolute native character position within <paramref name="text"/> and the logical position in UTF32 codepoints for each match. The former is useful for locating the match within a string programmatically while the latter is useful for locating text within a document based on its logical position.</remarks>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> MatchWhitespace(System.IO.TextReader text, long position = 0) {
            int adv;
            var sb = new System.Text.StringBuilder();
            var absoluteIndex = 0L;
            var cursorPos = position;
        ...
        /// <returns>An enumeration of tuples used to retrieve the match values.</returns>
        /// <remarks>The matches contain both the absolute native character position within <paramref name="text"/> and the logical position in UTF32 codepoints for each match. The former is useful for locating the match within a string programmatically while the latter is useful for locating text within a document based on its logical position.</remarks>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> MatchIdentifier(System.IO.TextReader text, long position = 0) {
            int adv;
            var sb = new System.Text.StringBuilder();
            var absoluteIndex = 0L;
            var cursorPos = position;
        ...
        /// <summary>Returns all occurances of the expression indicated by Keyword within <paramref name="text"/></summary>
        /// <param name="text">The text to search</param>
        /// <param name="position">The logical position in codepoints where the search started. By default assumes the beginning of the stream.</param>
        /// <returns>An enumeration of tuples used to retrieve the match values.</returns>
        /// <remarks>The matches contain both the absolute native character position within <paramref name="text"/> and the logical position in UTF32 codepoints for each match. The former is useful for locating the match within a string programmatically while the latter is useful for locating text within a document based on its logical position.</remarks>
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> MatchKeyword(System.IO.TextReader text, long position = 0) {
            int adv;
            var sb = new System.Text.StringBuilder();
            var absoluteIndex = 0L;
            var cursorPos = position;
