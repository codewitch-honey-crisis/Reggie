...
namespace ReggiePerf {
    ...
    partial class ExampleCompiledMatcher {static int _FetchNextInput(System.Collections.Generic.IEnumerator<char> cursor) {
...
/// <summary>Finds occurrances of a string matching the String expression.</summary>
        ...
        public static System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<long, string>> MatchString(System.Collections.Generic.IEnumerable<char> text, long position = 0) {
        ...
        /// <param name="position">The logical cursor position where the counting starts.</param>
        /// <returns>A <see cref="System.Collections.Generic.IEnumerable{System.Collections.Generic.KeyValuePair{System.Int64,System.String}}"/> object that enumerates the match information.</returns>
        public static System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<long, string>> MatchString(System.IO.TextReader text, long position = 0) {
            var sb = new System.Text.StringBuilder();
            var cursorPos = position;
