...
namespace ReggiePerf {
    ...
    partial class ExampleCompiledTokenizerWithLines {static int _FetchNextInput(System.Collections.Generic.IEnumerator<char> cursor) {
...
/// <summary>Represents a single token in a tokenized input stream</summary>
        ...
        public static System.Collections.Generic.IEnumerable<Token> Tokenize(System.Collections.Generic.IEnumerable<char> text, long position = 0, int line = 1, int column = 1, int tabWidth = 4) {
            ...
            q1:
                ...
                yield return new Token(Whitespace, sb.ToString(), position, line, column);
                    continue;
            q2:
                if(ch == '\t') {
                    sb.Append(unchecked((char)ch));
                ...
                goto error;
            q3:
                yield return new Token(String, sb.ToString(), position, line, column);
                    continue;
            q4:
                if(ch == '\t') {
                    sb.Append(unchecked((char)ch));
            ...
            q6:
                ...
                yield return new Token(Identifier, sb.ToString(), position, line, column);
                    continue;
            error:
