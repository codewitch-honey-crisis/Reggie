...
// Example.rgg specification file on 11/8/2021 6:45:36 AM UTC
namespace ReggiePerf {
    ...
    partial class ExampleTableMatcher {
        ...
        static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> TableMatch(int[] dfa, int[] blockEnd, System.IO.TextReader text, long position) {
            int adv;
        ...
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> MatchString(System.IO.TextReader text, long position = 0) {
            foreach(var result in TableMatch(StringDfaStateTable, null, text, position)) {
            	yield return result;
            }
        }
        ...
        public static System.Collections.Generic.IEnumerable<(long AbsolutePosition, int AbsoluteLength, long Position, int Length, string Value)> MatchKeyword(System.IO.TextReader text, long position = 0) {
            foreach(var result in TableMatch(KeywordDfaStateTable, null, text, position)) {
            	yield return result;
            }
        }
        // DFA state machine table
        static readonly int[] StringDfaStateTable = new int[] {
            -1, 1, 6, 1, 34, 34, -1, 3, 6, 3, 0, 33, 35, 91, 93, 1114111, 24, 1, 34, 34, 
            26, 1, 92, 92, 0, 0, -1, 3, 6, 3, 0, 33, 35, 91, 93, 1114111, 44, 1, 34, 34, 
            26, 1, 92, 92, 0, 3, 6, 3, 0, 33, 35, 91, 93, 1114111, 24, 1, 34, 34, 26, 1, 
            92, 92
        };
        // DFA state machine table
        static readonly int[] WhitespaceDfaStateTable = new int[] {
            -1, 1, 8, 2, 9, 13, 32, 32, 1, 1, 8, 2, 9, 13, 32, 32
        };
        // DFA state machine table
        static readonly int[] IdentifierDfaStateTable = new int[] {
            ...
            126635, 126651, 131072, 173782, 173824, 177972, 177984, 178205, 178208, 183969, 194560, 195101, 2, 1, 1112, 587, 48, 57, 65, 90, 
        ...
        // DFA state machine table
        static readonly int[] KeywordDfaStateTable = new int[] {
            -1, 18, 74, 1, 97, 97, 122, 1, 98, 98, 188, 1, 99, 99, 320, 1, 100, 100, 416, 1, 
            101, 101, 510, 1, 102, 102, 598, 1, 103, 103, 616, 1, 105, 105, 678, 1, 108, 108, 700, 1, 
            110, 110, 750, 1, 111, 111, 840, 1, 112, 112, 936, 1, 114, 114, 980, 1, 115, 115, 1138, 1, 
            116, 116, 1184, 1, 117, 117, 1252, 1, 118, 118, 1308, 1, 119, 119, -1, 2, 84, 1, 98, 98, 
            120, 1, 115, 115, -1, 1, 90, 1, 115, 115, -1, 1, 96, 1, 116, 116, -1, 1, 102, 1, 
            114, 114, -1, 1, 108, 1, 97, 97, -1, 1, 114, 1, 99, 99, -1, 1, 120, 1, 116, 116, 
            3, 0, -1, 4, 140, 1, 97, 97, 152, 1, 111, 111, 164, 1, 114, 114, 182, 1, 121, 121, 
            -1, 1, 146, 1, 115, 115, -1, 1, 120, 1, 101, 101, -1, 1, 158, 1, 111, 111, -1, 1, 
            120, 1, 108, 108, -1, 1, 170, 1, 101, 101, -1, 1, 176, 1, 97, 97, -1, 1, 120, 1, 
            107, 107, -1, 1, 146, 1, 116, 116, -1, 4, 206, 1, 97, 97, 228, 1, 104, 104, 268, 1, 
            108, 108, 286, 1, 111, 111, -1, 2, 146, 1, 115, 115, 216, 1, 116, 116, -1, 1, 222, 1, 
            99, 99, -1, 1, 120, 1, 104, 104, -1, 2, 238, 1, 97, 97, 244, 1, 101, 101, -1, 1, 
