...
namespace ReggiePerf {
    ...
    partial class ExampleCompiledTokenizer {static int _FetchNextInput(System.Collections.Generic.IEnumerator<char> cursor) {
...
/// <summary>Represents a single token in a tokenized input stream</summary>
        ...
        /// <summary>Indicates the String symbol id</summary>
        ...
        public static System.Collections.Generic.IEnumerable<Token> Tokenize(System.Collections.Generic.IEnumerable<char> text, long position = 0) {
            ...
            q1:
                ...
                yield return new Token(Whitespace, sb.ToString(), position);
                    continue;
            q2:
                ...
                goto error;
            q3:
                yield return new Token(String, sb.ToString(), position);
                    continue;
            q4:
                if((ch >= '\0' && ch <= '!') || (ch >= '#' && ch <= '[') || (ch >= ']' && ch <= 1114111)) {
                    sb.Append(char.ConvertFromUtf32(ch));
