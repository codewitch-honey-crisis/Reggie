...
// Example.rl specification file on 11/11/2021 7:33:27 AM UTC
namespace Test {
    
    /// <summary>Represents a checker for the regular expressions in Example.rl</summary>
    ...
    partial class Example {
        ...
        /// <summary>Indicates whether the <paramref name="text"/> matches the expression indicated by JsonStringLiteral</summary>
        /// <param name="text">The text to validate</param>
        /// <returns>True if the entire contents match the expression, otherwise false</returns>
        public static bool IsJsonStringLiteral(System.Collections.Generic.IEnumerable<char> text) {
            int adv;
        ...
        /// <param name="text">The text to validate</param>
        /// <returns>True if the entire contents match the expression, otherwise false</returns>
        public static bool IsVerbatimStringLiteral(System.Collections.Generic.IEnumerable<char> text) {
            int adv;
            var cursor = text.GetEnumerator();
            int ch;
            ch = ReadUtf32(cursor, out adv);
        ...
        /// <param name="text">The text to validate</param>
        /// <returns>True if the entire contents match the expression, otherwise false</returns>
        public static bool IsStringLiteral(System.Collections.Generic.IEnumerable<char> text) {
            int adv;
            var cursor = text.GetEnumerator();
            int ch;
            ch = ReadUtf32(cursor, out adv);
        ...
        /// <param name="text">The text to validate</param>
        /// <returns>True if the entire contents match the expression, otherwise false</returns>
        public static bool IsCharacterLiteral(System.Collections.Generic.IEnumerable<char> text) {
            int adv;
            var cursor = text.GetEnumerator();
            int ch;
            ch = ReadUtf32(cursor, out adv);
        ...
        /// <param name="text">The text to validate</param>
        /// <returns>True if the entire contents match the expression, otherwise false</returns>
        public static bool IsIntegerLiteral(System.Collections.Generic.IEnumerable<char> text) {
            int adv;
            var cursor = text.GetEnumerator();
            int ch;
            ch = ReadUtf32(cursor, out adv);
        ...
        /// <param name="text">The text to validate</param>
        /// <returns>True if the entire contents match the expression, otherwise false</returns>
        public static bool IsFloatLiteral(System.Collections.Generic.IEnumerable<char> text) {
            int adv;
            var cursor = text.GetEnumerator();
            int ch;
            ch = ReadUtf32(cursor, out adv);
        ...
        static bool IsCommentBlockBlockEnd(System.Collections.Generic.IEnumerator<char> cursor, int ch) {
            int adv;
            bool matched;
            while(ch != -1) {
                matched = false;
        ...
        /// <param name="text">The text to validate</param>
        /// <returns>True if the entire contents match the expression, otherwise false</returns>
        public static bool IsCommentBlock(System.Collections.Generic.IEnumerable<char> text) {
            int adv;
            var cursor = text.GetEnumerator();
            int ch;
            ch = ReadUtf32(cursor, out adv);
            ...
            q1:
                ...
                return false;
            q2:
                return IsCommentBlockBlockEnd(cursor, ch);
            }
            return false;
        }
    }
